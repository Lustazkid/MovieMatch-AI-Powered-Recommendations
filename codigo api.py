   ...
   "outputs": [
    {
     ...
     "text": [
      ...
      "                                                cast  \\\n",
      "0  [{'cast_id': 2, 'character': 'Major Robert Rog...   \n",
      "1  [{'cast_id': 4, 'character': 'Macklin', 'credi...   \n",
      "2  [{'cast_id': 4, 'character': 'Michael', 'credi...   \n",
      "3  [{'cast_id': 3, 'character': 'Charlotte', 'cre...   \n",
      "4  [{'cast_id': 1, 'character': 'Judge Joseph Dre...   \n",
      "\n",
      "                                                crew     id  \n",
      "0  [{'credit_id': '574f52cc92514118530002f4', 'de...  43805  \n",
      "1  [{'credit_id': '54e1acee925141195a0069da', 'de...  26762  \n",
      "2  [{'credit_id': '52fe45dc9251416c75064faf', 'de...  14237  \n",
      "3  [{'credit_id': '52fe460c9251416c7506b55b', 'de...  14651  \n",
      "4  [{'credit_id': '52fe44fdc3a36847f80b62b9', 'de...   9482  \n",
      "\n",
      ...
      " #   Column  Non-Null Count  Dtype \n",
      "---  ------  --------------  ----- \n",
      " 0   cast    5684 non-null   object\n",
      " 1   crew    5684 non-null   object\n",
      " 2   id      5684 non-null   int64 \n",
   ...
   "outputs": [
    {
     ...
     "text": [
      "<class 'pandas.core.frame.DataFrame'>\n",
      "Index: 1421 entries, 1755 to 1108\n",
      "Data columns (total 3 columns):\n",
      " #   Column  Non-Null Count  Dtype \n",
      "---  ------  --------------  ----- \n",
      " 0   cast    1421 non-null   object\n",
      " 1   crew    1421 non-null   object\n",
      " 2   id      1421 non-null   int64 \n",
      "dtypes: int64(1), object(2)\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "INFO:     Started server process [3156]\n",
      ...
      "INFO:     Finished server process [3156]\n"
     ]
    }
   ],
   "source": [
